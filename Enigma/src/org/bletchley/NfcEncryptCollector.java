...
public class NfcEncryptCollector extends Activity{
    ...
    void resolveIntent(Intent intent) {
        ...
        if ("android.nfc.action.NDEF_DISCOVERED".equals(action)) {
            ...
            Log.i("TAG", "ENCRYPT: Secret key is" + t.getText());
            
            String text = EncryptMgr.encrypt(t.getText(), this.msg);
        	...
        	Log.i("TAG", "ENCRYPT: sharing:" + text);
